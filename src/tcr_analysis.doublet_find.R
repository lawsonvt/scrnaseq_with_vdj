...
# load in data
out_dir <- "results/tcr_analysis.doublet_find/"
...
tcell_seu <- LoadSeuratRds("results/tcell_split.doublet_find/tcell_subset.named.seurat.RDS")
...
tcell_seu$condition <- metadata$condition
