...
out_dir <- "results/tcell_subset.diff_exp_fgsea.pseudobulk/"
...
results_file <- "results/tcell_subset.diff_exp_analysis.pseudobulk/ps19ko_minus_ps19wt.de_results.RDS"
