...
# rename "microglia"
seu_obj$merged_cell_name <- gsub("^Microglia$", "Unknown Microglia", seu_obj$merged_cell_name)
# replace plus sign
...
ggsave(paste0(out_dir, "ps19ko_minus_ps19wt.volcano_plots.png"), width=14, height=10)
