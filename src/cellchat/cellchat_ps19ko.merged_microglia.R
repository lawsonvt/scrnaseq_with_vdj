...
out_dir <- "results/cellchat_ps19ko.merged_microglia/"
...
# alter some metadata
metadata <- subset_seu@meta.data

metadata[metadata$cell_category == "Microglia",]$merged_cell_name <- "Microglia"

subset_seu$merged_cell_name <- metadata$merged_cell_name
