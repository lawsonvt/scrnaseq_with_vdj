...
out_dir <- "results/microglia_subset.diff_exp_fgsea.pseudobulk/"
...
results_file <- "results/microglia_subset.diff_exp_analysis.pseudobulk/ps19ko_minus_ps19wt.de_results.RDS"
